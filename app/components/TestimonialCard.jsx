...
export default function TestimonialCard({ img, comment, name, time }) {
  return (
    <div className="block rounded-md  p-4 shadow-sm sm:p-6 col-span-1 bg-[#ffffff] border-2 border-transparent hover:border-[#007E85] transition-all">
      <div className="sm:flex sm:justify-between sm:gap-4 lg:gap-6">
        ...
        <div className="mt-4 sm:mt-0">
          ...
          <p className="mt-1 text-sm text-gray-700">By {name}</p>
      ...
      <dl className="mt-6 flex gap-4 lg:gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <dd className="text-xs text-gray-700">{time} minutes</dd>
        </div>
      </dl>
    </div>
  );
